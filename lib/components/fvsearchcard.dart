            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  width: x*0.56,
                  // ignore: prefer_const_constructors
                  child: Text(product.name,style: TextStyle(fontSize: 14.5, fontWeight: FontWeight.w600)),
                ),
                // ignore: prefer_const_constructors
                SizedBox(height: 6),
                // ignore: avoid_unnecessary_containers
                Container(
                  child: Row(
                    children: [
                      ...
                      // ignore: prefer_const_constructors
                      Text(product.price+' ('+product.quantity+')', style: TextStyle(fontSize: 14.5, fontWeight: FontWeight.w600)),
                    ],
                  ),
                ),
                // ignore: prefer_const_constructors
                  ...
                  children: [
                    ...
                    GestureDetector(
                        ...
                        child: Container(
                          // ignore: prefer_const_constructors
                          child: Text(
                            'ADD TO CART',style: CustomTextStyles.FVATCText
                          ),),),
                  ],
                ),
              ],
